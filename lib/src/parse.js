...
const parseDir = (openAi, srcDir, outDir, exclude, ignoreCache) => __awaiter(void 0, void 0, void 0, function* () {
    const cache = flat_cache_1.default.load("ifls", path_1.default.resolve(`${srcDir}/.ifls.cache`));
    ...
    files.forEach((file) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (matches) {
            ...
            const completions = yield Promise.all(matches.map((match) => __awaiter(void 0, void 0, void 0, function* () {
                ...
                const openAiRes = yield openAi.call(match.code, 500);
